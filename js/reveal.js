...
(function (root, factory) {
	...
	var SLIDES_SELECTOR = '.slides section',
		...
		config = {
			...
			// Display a slide as speaker notes
			notes: false,
	...
	function configure(options) {
		...
		if (isSpeakerNotes()) {
			...
			console.log('controls:', config.controls);
			if (config.controls === false) { // if upcoming
				dom.wrapper.style.zoom = "50%";
			} else { // next slide
				dom.wrapper.style.zoom = "75%";
			}
		}
